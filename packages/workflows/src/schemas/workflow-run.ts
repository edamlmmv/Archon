 ...
 * `output` is the literal concatenated assistant text. Empty string for failed/skipped nodes.
 * `structuredOutput` is the provider-parsed output_format payload, when available.
